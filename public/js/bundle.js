  ...
  _createClass(Home, [{
    ...
    value: function render() {
      ...
      var tapRows = this.state.taps.map(function (tap) {
        ...
        return _react2.default.createElement(
          'tbody',
          { key: "small-" + tap._id, className: rowStyle },
          _react2.default.createElement(
            'tr',
            { className: 'hidden-sm hidden-xs visible-md visible-lg' },
            _react2.default.createElement(
              'td',
              { colSpan: '1', className: 'tap' },
              _react2.default.createElement(
                'div',
                { className: 'tapcircle' },
                tap.kegerator,
      ...
      var tapRowsSmall = this.state.taps.map(function (tap) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'td',
              { colSpan: '2', className: 'srm' },
              _react2.default.createElement(_SrmWidget2.default, { keg: tap.keg })
            ),
            _react2.default.createElement(
              'td',
              { colSpan: '2', className: 'ibu' },
              _react2.default.createElement(_IbuWidget2.default, { keg: tap.keg })
            ),
            _react2.default.createElement(
              'td',
              { colSpan: '2', className: 'abv' },
              _react2.default.createElement(_AbvWidget2.default, { keg: tap.keg })
            ),
            _react2.default.createElement(
              'td',
              { colSpan: '2', className: 'qty' },
              _react2.default.createElement(_QuantityWidget2.default, { keg: tap.keg })
            )
          )
        );
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'table',
          { className: 'table no-border hidden-sm hidden-xs visible-md visible-lg' },
          tapRows
        ),
        _react2.default.createElement(
          'table',
          { className: 'table no-border visible-sm visible-xs hidden-md hidden-lg' },
          tapRowsSmall
        )
      );
    }
			...
			if (keg && keg.abv) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'p',
						null,
						(0, _numeral2.default)(abv).format('0.0%'),
						' ABV'
					)
				);
			} else {
			...
			if (keg && keg.ibu) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'p',
						null,
						(0, _numeral2.default)(ibu).format('0'),
						' IBU'
					)
				);
			} else {
			...
			if (keg && quantityInitial && quantityRemaining) {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'p',
						null,
						(0, _numeral2.default)(quantityRemaining).format(0),
						' fl oz'
					)
				);
			} else {
